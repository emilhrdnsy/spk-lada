        ...
        if ($numrows > 0) {
          ...
          <thead>
            <tr>
              ...
              <th style='text-align:center; vertical-align: middle'>Saran Penyakit</th>
        ...
        if ($baris > 0) {
          ...
          while ($r = mysqli_fetch_array($hasil)) {
            if ($counter % 2 == 0)
              ...
              $warna = "light";
            echo "<tr class='" . $warna . "'>
              <td style='text-align:center; vertical-align: middle'>P$no</td>
              <td style='vertical-align: middle'>$r[nama_penyakit]</td>
              <td style='vertical-align: middle'>$r[det_penyakit]</td>
              <td style='vertical-align: middle'>$r[srn_penyakit]</td>
              <td align=center>
