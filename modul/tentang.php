...
<body>
  ...
  <article class="tc w-75 center pt5 pb2 ph3 mw6-ns ba bw1 b--light-gray" style="background: #fff;">
    <header class="mb4">
      ...
      <h1 class="f3 lh-title mv2 dark-gray">Sistem Pakar Lada</h1>
	  ...
	  <!-- <a class="link dim light-silver"  style="font-size: 40px;"> | </a>
	       <a class="link dim light-silver"  style="font-size: 40px;"> 	<img src="aset/tentang/" alt="Profile headshot" /></a> -->
    </header>
    <p class="f6 tl lh-copy silver" style="margin: 20px; text-align: justify;">Sistem pakar yang mampu mendiagnosa penyakit pada tanaman lada berdasarkan pengetahuan yang diberikan langsung dari pakar/ahlinya dan melalui studi  literatur. Penelitian ini menggunakan metode perhitungan Certainty Factor (CF) dalam menghitung tingkat kepakaran. Data penelitian ini terdiri dari data gejala dan data penyakit tanaman lada, serta data aturan. Sistem pakar pada organisasi ditujukan  untuk penambahan  value, peningkatan produktivitas serta area manajerial yang dapat mengambil kesimpulan dengan cepat.</p>
  </article>
</div>
</body>
